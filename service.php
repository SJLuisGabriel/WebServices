                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">Si el sitio web requiere una 
                            ...
                            es posible que necesite un backend robusto. 
                            Esto podría incluir la creación de una API 
                            RESTful, la configuración de una base de datos 
                            y el desarrollo de lógica empresarial 
                            utilizando tecnologías como o PHP 
                            (con Laravel o Symfony).</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x bx bxs-shield-x mx-auto mb-4" style="font-size: 45px;"></i>
                        <h5 class="mb-2">Seguridad y Mantenimiento</h5>
                        <p class="m-0">Configuración de medidas de seguridad 
                            adecuadas para proteger el sitio web contra 
                            amenazas en línea, como ataques de seguridad y 
                            piratería. Además, se ofrecen servicios de 
                            mantenimiento continuo para garantizar que el 
                            sitio esté actualizado, seguro y funcionando correctamente. </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-2x bx bxs-message-alt-check mx-auto mb-4" style="font-size: 45px;"></i>
                        <h5 class="mb-2">Pruebas y Control de Calidad</h5>
                        <p class="m-0">Pruebas exhaustivas que garantizan 
                            el correcto funcionamiento del sitio web en 
                            diversos dispositivos y navegadores. Se 
                            verifican todas las funcionalidades para 
                            corregir errores y asegurar una experiencia de 
                            usuario satisfactoria en términos de navegación, 
                            rendimiento y seguridad.</p>
                    </div>
                </div>
            </div>
        </div>
